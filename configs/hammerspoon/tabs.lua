...
tabs.textTopPad = 1
tabs.textSize = 10
tabs.fillColor = {red = 1.0, green = 1.0, blue = 1.0, alpha = 0.0}
tabs.selectedColor = {red = .9, green = .9, blue = .9, alpha = 0.0}
tabs.strokeColor = {red = 1.0, green = 1.0, blue = 1.0, alpha = 0.3}
tabs.selectedStrokeColor = {red = 1.0, green = 1.0, blue = 1.0, alpha = 0.8}
tabs.textColor = {red = 1.0, green = 1.0, blue = 1.0, alpha = 0.5}
tabs.selectedTextColor = {red = 1.0, green = 1.0, blue = 1.0, alpha = 1.0}
tabs.maxTitle = 15
...
local function drawTabsReal(app)
  ...
  for i=0,(numTabs-1) do
    ...
    if win == proto then
      ...
      r:setStrokeColor(tabs.selectedStrokeColor)
    else
    ...
    if win == proto then
      t:setTextColor(tabs.selectedTextColor)
    else
